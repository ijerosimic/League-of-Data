        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SummonerSpell = table.Column<string>(nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Champions",
                columns: new[] { "ID", "ChampionDescription", "ChampionName", "ChampionTitle" },
                values: new object[,]
                {
                    { 266, "Desc", "Champion", "Title" },
                    { 103, "Desc", "Champion", "Title" },
                    { 12, "Desc", "Champion", "Title" },
                    { 32, "Desc", "Champion", "Title" },
                    { 164, "Desc", "Champion", "Title" },
                    { 42, "Desc", "Champion", "Title" },
                    { 131, "Desc", "Champion", "Title" },
                    { 9, "Desc", "Champion", "Title" },
                    { 79, "Desc", "Champion", "Title" },
                    { 420, "Desc", "Champion", "Title" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 5, 0, 88407, 71, 11, "CLASSIC", "MATCHED_GAME", 11, new DateTime(2019, 11, 23, 13, 26, 54, 956, DateTimeKind.Local).AddTicks(2528), 4240, 440, 1, 0, 0, 77988, 47, 3, 5, 2, 166395, 108, "Blue" },
                    { 2, 0, 0, 0, 0, 0, 0, "CLASSIC", "MATCHED_GAME", 11, new DateTime(2019, 11, 23, 13, 26, 54, 958, DateTimeKind.Local).AddTicks(8870), 2415, 440, 0, 0, 0, 0, 0, 0, 13, 2, 0, 0, null },
                    { 3, 0, 0, 0, 0, 0, 0, "CLASSIC", "MATCHED_GAME", 11, new DateTime(2019, 11, 23, 13, 26, 54, 958, DateTimeKind.Local).AddTicks(8943), 4151, 440, 0, 0, 0, 0, 0, 0, 13, 2, 0, 0, null },
                    { 4, 0, 0, 0, 0, 0, 0, "CLASSIC", "MATCHED_GAME", 11, new DateTime(2019, 11, 23, 13, 26, 54, 958, DateTimeKind.Local).AddTicks(8948), 2415, 440, 0, 0, 0, 0, 0, 0, 13, 2, 0, 0, null },
                    { 5, 0, 0, 0, 0, 0, 0, "CLASSIC", "MATCHED_GAME", 11, new DateTime(2019, 11, 23, 13, 26, 54, 958, DateTimeKind.Local).AddTicks(8951), 2415, 440, 0, 0, 0, 0, 0, 0, 13, 2, 0, 0, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "SummonerID", "MatchID", "Assists", "ChampionID", "DamageDone", "Deaths", "GoldEarned", "ID", "Item1", "Item2", "Item3", "Item4", "Item5", "Item6", "KeystoneRune", "KillParticipation", "Kills", "LaneName", "MinorRune", "RoleName", "SummonerSpell", "SummonerSpell2", "Team", "Trinket", "WardsPlaced" },
                values: new object[,]
                {
                    { 1, 1, 5, 266, 43.511m, 18, 21.523m, 1, "Boots of Speed", "Infinity Edge", "BF Sword", "Statikk Shiv", "Essence Reaver", "Death's Dance", "Lethal Tempo", 0, 11, "BOTTOM", "Resolve", "DUO_MARKSMAN", null, null, "Blue", "Warding Totem", 14 },
                    { 2, 1, 5, 103, 43.511m, 18, 21.523m, 2, "Boots of Speed", "Infinity Edge", "BF Sword", "Statikk Shiv", "Essence Reaver", "Death's Dance", "Lethal Tempo", 0, 11, "MID", "Resolve", "SOLO_MID", null, null, "Blue", "Warding Totem", 14 },
                    { 3, 1, 5, 12, 43.511m, 18, 21.523m, 3, "Boots of Speed", "Infinity Edge", "BF Sword", "Statikk Shiv", "Essence Reaver", "Death's Dance", "Lethal Tempo", 0, 11, "BOTTOM", "Resolve", "DUO_SUPPORT", null, null, "Blue", "Warding Totem", 14 },
                    { 4, 1, 5, 32, 43.511m, 18, 21.523m, 4, "Boots of Speed", "Infinity Edge", "BF Sword", "Statikk Shiv", "Essence Reaver", "Death's Dance", "Lethal Tempo", 0, 11, "JUNGLE", "Resolve", "SOLO_JUNGLE", null, null, "Blue", "Warding Totem", 14 },
                    { 5, 1, 5, 164, 43.511m, 18, 21.523m, 5, "Boots of Speed", "Infinity Edge", "BF Sword", "Statikk Shiv", "Essence Reaver", "Death's Dance", "Lethal Tempo", 0, 11, "TOP", "Resolve", "SOLO_TOP", null, null, "Blue", "Warding Totem", 14 },
                    { 6, 1, 5, 42, 43.511m, 18, 21.523m, 6, "Boots of Speed", "Infinity Edge", "BF Sword", "Statikk Shiv", "Essence Reaver", "Death's Dance", "Lethal Tempo", 0, 11, "BOTTOM", "Resolve", "DUO_MARKSMAN", null, null, "Red", "Warding Totem", 14 },
                    { 7, 1, 5, 131, 43.511m, 18, 21.523m, 7, "Boots of Speed", "Infinity Edge", "BF Sword", "Statikk Shiv", "Essence Reaver", "Death's Dance", "Lethal Tempo", 0, 11, "MID", "Resolve", "SOLO_MID", null, null, "Red", "Warding Totem", 14 },
                    { 8, 1, 5, 9, 43.511m, 18, 21.523m, 8, "Boots of Speed", "Infinity Edge", "BF Sword", "Statikk Shiv", "Essence Reaver", "Death's Dance", "Lethal Tempo", 0, 11, "BOTTOM", "Resolve", "DUO_SUPPORT", null, null, "Red", "Warding Totem", 14 },
                    { 9, 1, 5, 79, 43.511m, 18, 21.523m, 9, "Boots of Speed", "Infinity Edge", "BF Sword", "Statikk Shiv", "Essence Reaver", "Death's Dance", "Lethal Tempo", 0, 11, "JUNGLE", "Resolve", "SOLO_JUNGLE", null, null, "Red", "Warding Totem", 14 },
                    { 10, 1, 5, 420, 43.511m, 18, 21.523m, 10, "Boots of Speed", "Infinity Edge", "BF Sword", "Statikk Shiv", "Essence Reaver", "Death's Dance", "Lethal Tempo", 0, 11, "TOP", "Resolve", "SOLO_TOP", null, null, "Red", "Warding Totem", 14 }
                });
